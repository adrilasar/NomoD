...
2. Descarga la última versión de **NomoD** y **GeckoLib** desde [aquí](https://github.com/adrilasar/NomoD/releases/latest).
3. (_**Opcional**_) Descarga la última versión de **Storage-Network** desde [aquí](https://github.com/adrilasar/Storage-Network/releases/latest). 

3. Coloca los _**.jar**_ en la carpeta **`../mods`**
